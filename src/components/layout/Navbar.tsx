        ...
        <div className="flex items-center" style={{ gap: 16 }}>
          ...
          <div className="hidden lg:block">
            <div className="flex items-center" style={{ gap: 8 }}>
              ...
              {user?.email && (
                <span className="text-slate-400 font-normal" style={{ fontSize: 18 }}>
                  · {user.email.split("@")[0]}
                </span>
              )}
            </div>
            <p className="text-slate-500" style={{ fontSize: 13, marginTop: 2 }}>
          ...
          <div className="relative" ref={profileRef}>
            <button
              ...
              style={{
                ...
                backgroundColor: profileOpen ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.03)',
            ...
            {profileOpen && (
              ...
              >
                ...
                <div style={{ padding: '12px 12px 14px' }}>
                  <div className="flex items-center" style={{ gap: 10 }}>
                    ...
                    <div style={{ overflow: 'hidden' }}>
                      ...
                      <p className="text-slate-500 truncate" style={{ fontSize: 12 }}>
                ...
                {/* Divider */}
                <div style={{ height: 1, backgroundColor: 'rgba(255,255,255,0.06)', margin: '0 4px' }} />
