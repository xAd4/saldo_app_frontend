...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-emerald-500/8 blur-[120px] animate-float-orb-1" />
      <div className="absolute bottom-[-15%] left-[-10%] w-[600px] h-[600px] rounded-full bg-cyan-500/8 blur-[140px] animate-float-orb-2" />
      <div className="absolute top-[40%] left-[60%] w-[300px] h-[300px] rounded-full bg-teal-500/6 blur-[100px] animate-float-orb-3" />
      ...
      <div className="relative z-10" style={{ width: "100%", maxWidth: 460 }}>
        ...
        <div className="relative animate-fade-in-up-delay-1">
          ...
          <div className="absolute -inset-[1px] rounded-3xl bg-gradient-to-br from-emerald-500/20 via-transparent to-cyan-500/20 animate-pulse-glow" />
          ...
          >
            ...
            >
              <label className="flex items-center gap-2.5 cursor-pointer group/check">
                ...
                <span className="text-sm text-slate-400 group-hover/check:text-slate-300 transition-colors select-none">
                  Recuérdame
                </span>
              </label>
              <Link
